    ...
    <div className="print-page">
      ...
      <div className="print-header">
        <div>
          ...
          <div style={{ fontSize: '0.8rem', color: 'var(--muted)' }}>Yoma Dental Clinic — Prescription</div>
        </div>
      ...
      <p style={{ fontSize: '0.75rem', color: 'var(--muted)', marginTop: 30 }}>
        Generated by Yoma on {new Date().toLocaleString()}. Take medication exactly as directed
